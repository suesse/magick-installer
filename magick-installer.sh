...
download http://heanet.dl.sourceforge.net/project/ghostscript/GPL%20Ghostscript/9.02/ghostscript-9.02.tar.gz
...
download ftp://ftp.sunet.se/pub/multimedia/graphics/ImageMagick/ImageMagick-6.6.9-3.tar.gz
...
tar xzvf ImageMagick-6.6.9-3.tar.gz
cd ImageMagick-6.6.9-3
